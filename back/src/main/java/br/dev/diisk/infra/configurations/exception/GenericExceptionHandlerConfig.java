...
public class GenericExceptionHandlerConfig {
    ...
    public ResponseEntity<?> handleException(AuthorizationDeniedException ex) {
        return responseService.unauthorized(new ErrorDetailsResponse(MessageUtils.getMessage("exception.access.denied"), null));
    }
    
    @ExceptionHandler(CustomRuntimeException.class)
    public ResponseEntity<?> handleCustomRuntimeException(CustomRuntimeException ex) {
        System.err.println(ex);
        return responseService.internal(new ErrorDetailsResponse(MessageUtils.getMessage("exception.not-handled"), null));
    }
    ...
    public ResponseEntity<?> handleMethodArgumentNotValidException(MethodArgumentNotValidException ex) {
        return responseService.badRequest(MessageUtils.getMessage("exception.invalid.method-argument"),
